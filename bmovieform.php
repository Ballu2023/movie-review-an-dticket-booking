...
$inserting_query="insert into  movie_update (Movie_id,movie1_title,director,producer,actor,description,venue_name_one,venue_name_two,	venue_name_three,time_slot_one,actortime_slot_two,actortime_slot_three,keyword,image_1,rating,Price,status,date) value ('$book_id','$Moview_title','$Moview_producer','$Moview_director','$Moview_actoir','$Moview_description','$venue_name1','$venue_name2','$venue_name3','$Slot_time1','$Slot_time2','$Slot_time3','$Moview_Keyword','$Moview_image1','$Moview_ratting',$Moview_price,NOW(),'$booking_statu')";
